	...
	export default{
				...
				contactLeft:[
					{
						...
						pContent:'Mail:<a style="color:#00a78e" href="mailto:18823547629@163.com">18823547629@163.com</a>'
					},
					{
							faClass:'fa-phone',
						title:'Contact By Phone',
						pContent:'Phone:<span style="cursor:pointer;color:#00a78e">18823547629</span>'
					},
					{
						faClass:'fa-home',
						title:'Contact By Home',
						pContent:'Address:<span style="cursor:pointer;color:#00a78e">华南农业大学</span>'
					}
				],
				aboutThis:[
					{
		...
		methods:{
			sendEmail(){
				...
				xhr.open('post','http://112.74.33.129:8844/post',true);
				xhr.send(formdata);
...
<style scoped>
	...
	#contact{
			width: 100%;
			min-height: 580px;
			background:rgb(4,4,4) url('http://bukesiyi.top/worksImage/contact.jpg') 0 0/cover;
			padding: 2rem;
